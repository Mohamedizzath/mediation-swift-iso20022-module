...
public class FieldPDM extends Field {
    ...
    public FieldPDM setTime(String time) {
        this.time = time;
        return this;
    }
    ...
    public FieldPDM setDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public FieldPDM setLtIdentifier(String ltIdentifier) {
    ...
    public FieldPDM setSessionNumber(String sessionNumber) {
    ...
    public FieldPDM setSequenceNumber(String sequenceNumber) {
