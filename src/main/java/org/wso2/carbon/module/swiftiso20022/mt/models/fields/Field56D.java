...
public class Field56D {
    ...
    public static final String TAG = "56D";
     ...
     */
    public Field56D withPartyIdentifier(String partyIdentifier) {
     ...
     * @return object itself
     */
    public Field56D withDetails(List<String> details) {
        setDetails(details);
        return this;
    }

    /**
     * Method to parse and get Field56D object.
     *
     * @param field56DString String containing value of 56D field in Text Block
     * @return An instance of this model.
     * @throws MTMessageParsingException if the value is invalid
     */
    public static Field56D parse(String field56DString) throws MTMessageParsingException {

        // Get matcher to the regex matching -> [/(Party Identifier)]
        //                                      (Details)
        Optional<Matcher> field56DMatcher = MTParserUtils.getRegexMatcher(
                MTParserConstants.PARTY_IDENTIFIER_OPTION_D_REGEX_PATTERN, field56DString);

        if (field56DMatcher.isPresent()) {

            Matcher matcher = field56DMatcher.get();
