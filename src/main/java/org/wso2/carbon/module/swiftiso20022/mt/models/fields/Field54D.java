...
public class Field54D {
    ...
    public static final String TAG = "54D";
     ...
     */
    public Field54D withPartyIdentifier(String partyIdentifier) {
     ...
     * @return object itself
     */
    public Field54D withDetails(List<String> details) {
        setDetails(details);
        return this;
    }

    /**
     * Method to parse and get Field54D object.
     *
     * @param field54DString String containing value of 54D field in Text Block
     * @return An instance of this model.
     * @throws MTMessageParsingException if the value is invalid
     */
    public static Field54D parse(String field54DString) throws MTMessageParsingException {

        // Get matcher to the regex matching -> [/(Party Identifier)]
        //                                      (Details)
        Optional<Matcher> field54DMatcher = MTParserUtils.getRegexMatcher(
                MTParserConstants.PARTY_IDENTIFIER_OPTION_D_REGEX_PATTERN, field54DString);

        if (field54DMatcher.isPresent()) {

            Matcher matcher = field54DMatcher.get();
