...
public class Field54A {
     ...
     */
    public Field54A withPartyIdentifier(String partyIdentifier) {
     ...
     * @return object itself
     */
    public Field54A withIdentifierCode(String identifierCode) {
        setIdentifierCode(identifierCode);
        return this;
    }

    /**
     * Method to parse and get Field54A object.
     *
     * @param field54AString String containing value of 54A field in Text Block
     * @return An instance of this model.
     * @throws MTMessageParsingException if the value is invalid
     */
    public static Field54A parse(String field54AString) throws MTMessageParsingException {

        // Get matcher to the regex matching -> [/(Party Identifier)]
        //                                      (Identifier Code)
        Optional<Matcher> field54AMatcher = MTParserUtils.getRegexMatcher(
                MTParserConstants.PARTY_IDENTIFIER_OPTION_A_REGEX_PATTERN, field54AString);

        if (field54AMatcher.isPresent()) {

            Matcher matcher = field54AMatcher.get();
