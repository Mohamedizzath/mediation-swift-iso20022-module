...
public class Field54 extends PartyIdentifier {
     ...
     */
    public static Field54 parse(char option, String field54String) throws MTMessageParsingException {
        ...
        if (field54Matcher.matches()) {
            ...
            throw new MTMessageParsingException(String.format(MTParserConstants.INVALID_FIELD_IN_BLOCK_MESSAGE,
                    ConnectorConstants.FIELD_54 + (option == ConnectorConstants.NO_LETTER_OPTION ? "" : option),
