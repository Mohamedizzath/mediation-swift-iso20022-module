...
import org.wso2.carbon.module.swiftiso20022.utils.MT940ParserConstants;

/**
 * Test class for MT940Parser.
 */
public class MT940ParserTests {
    @Test(dataProvider = "parseMT940TextBlock", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidTransactionReferenceNumber", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidRelatedReference", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidAccountIdentification", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidAccountIdentificationOptP", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidStmtSeqNumber", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidOpeningBalanceOptF", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidOpeningBalanceOptM", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidStmtLine", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidStmtLineInfoToAccOwner", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidClosingBalanceOptF", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidClosingBalanceOptM", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidClosingAvlBalance", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            ...
            dataProvider = "invalidForwardAvlBalance", dataProviderClass = MT940ParserConstants.class)
    ...
    @Test(expectedExceptions = MTMessageParsingException.class,
            expectedExceptionsMessageRegExp = "86 field not in the correct format",
            dataProvider = "invalidInfoToAccOwner", dataProviderClass = MT940ParserConstants.class)
