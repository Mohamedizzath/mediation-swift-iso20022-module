...
import org.wso2.carbon.module.swiftiso20022.mt.format.validators.MTBlockFormatValidator;
...
public class MTBlockFormatValidatorTests {
    ...
    Object[][] getInvalidFormatUserHeaderBlockDataProvider() {
        return new Object[][] {
                ...
                {"{123:some value}{}"},
                {"{123:some value}{ABC:}"},
                {"{123:some value}{123:another value}"},
                {"{111:some value}{121:another value}"},
        };
    }

    @Test(dataProvider = "invalidFormatUserHeaderBlockDataProvider")
    public void testValidateUserHeaderBlock(String userHeaderBlock) {
    ...
    Object[][] getInvalidFormatTrailerBlockDataProvider() {
        return new Object[][] {
                ...
                {"{ABC:some value}{}"},
                {"{ABC:some value}{123:}"},
                {"{ABC:some value}{ABC:another value}"},
        };
    }
